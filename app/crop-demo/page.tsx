'use client';
import { XCanvas, XImage, XTextbox, XImageCropper } from '@boardxus/canvasx-core';
...
const CropDemoPage: NextPage = () => {
    ...
    const onLoad = useCallback(
        (canvas: XCanvas) => {
            ...
            demoImage.src = 'https://images.unsplash.com/photo-1606787366850-de6330128bfc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80';
    ...
    return (
        <div className="position-relative">
            ...
            >
                <Typography level="h4" mb={2}>Image Crop Tools</Typography>
                <Divider sx={{ my: 2 }} />
            ...
            >
                <Typography level="body-md" textAlign="center">
                    This demo shows how to crop images using the XImageCropper widget.
                    Use the tools on the right to start cropping, apply or cancel the crop,
